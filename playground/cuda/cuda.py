...
def find_cuda_libs(self):
	...
	self.check_cxx(header_name='cuda.h', lib='cuda', libpath=_libpath, includes=_includes, msg='Checking for header cuda.h and library cuda')
	self.check_cxx(header_name='cuda.h', lib='cudart', libpath=_libpath, includes=_includes, msg='Checking for header cuda.h and library cudart')
